  ...
  return (
    <section className="flex min-h-[calc(100vh-9rem)] items-center justify-center">
      <div className="w-full max-w-lg rounded-lg border border-border bg-surface p-6 shadow-soft">
        ...
        <h1 className="text-xl font-semibold text-text-main">Dashboard error</h1>
        <p className="mt-2 text-sm leading-6 text-text-muted">
          This dashboard view failed to render. Retry the view or head back to the dashboard home.
        </p>
        {error?.message ? (
